        ...
        <div class="grid gap-8 md:grid-cols-2 scroll-mt-[200px] items-center">
            <div class="flex flex-col justify-center">
                ...
                <div class="grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-4 pt-8 border-t border-gray-800 text-gray-400">
                    <div>
                        <h3 class="font-semibold ">Top Up</h3>
                        <div class="h-4"></div>
                        <p class="">
                ...
                <form class="flex flex-col gap-5 max-w-[350px]  [&>div]:flex  [&>div]:flex-col  [&>div]:gap-2  [&>div]:text-gray-300">
                    <div>
                        ...
                        <div class="flex gap-5">
                            <label class="inline-flex relative self-start p-3 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-2 focus:outline-indigo-900 bg-gradient-to-b hover:from-indigo-900 from-gray-900 to-black has-checked:from-indigo-900! has-checked:hover:from-gray-900! has-checked:border-slate-600! has-focus:outline-2 has-focus:outline-indigo-900" for="topup">
                                Top Up
                                <input type="radio" name="type" required class="opacity-0 absolute inset-0" value="Top Up" id="topup">
                            </label>
                            <label class="inline-flex relative self-start p-3 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-2 focus:outline-indigo-900 bg-gradient-to-b hover:from-indigo-900 from-gray-900 to-black has-checked:from-indigo-900! has-checked:hover:from-gray-900! has-checked:border-slate-600! has-focus:outline-2 has-focus:outline-indigo-900" for="convert">
                                Convert
                                <input type="radio" name="type" required class="opacity-0 absolute inset-0" value="Convert" id="convert">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="">
                        <button
                            class="flex items-center gap-3 mt-2 self-start p-3 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-2 focus:outline-indigo-900 bg-gradient-to-b hover:from-indigo-900 from-gray-900 to-black text-sm">
                            ...
                            <div class="">
                                <span id="buttonType">Pesan </span>&nbsp;Sekarang
                            </div>
                        </button>
                    </div>
...
<script>
    ...
    transcationType.forEach(e => {
        ...
        e.addEventListener('click', () => {
            ...
            if (buttonType.innerHTML != e.value) {
    ...
    const count = (nominal) => {
        const data = buttonType.innerHTML === "Top Up" ? topUp : convert;
...
Saya ingin ${buttonType.innerHTML} Paypal: 
